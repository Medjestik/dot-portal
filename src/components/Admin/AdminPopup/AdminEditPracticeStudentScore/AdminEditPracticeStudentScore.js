...
function AdminEditPracticeStudentScore({ isOpen, onClose, practice, currentStudent, onEdit, isLoadingRequest, isShowRequestError }) {
 
  const [score, setScore] = React.useState(currentStudent.mark);
  const [comment, setComment] = React.useState(currentStudent.komment);
  const [transfer, setTransfer] = React.useState(currentStudent.transfer === 'false' ? false : true);
  ...
  function handleSubmit(e) {
    ...
    const data = {
        transfer: transfer === false ? 'false' : 'true',
        mark: score,
        komment: comment,
    }
    onEdit(data);
  ...
  return (
    <Popup
      ...
      formWidth={'medium'}
      formName={'admin-edit-practice-score-popup'}
    >
        ...
        <div className='popup__field'>
            ...
            name='edit-practice-student-score-comment'
            id='edit-practice-student-score-comment'
...
export default AdminEditPracticeStudentScore;