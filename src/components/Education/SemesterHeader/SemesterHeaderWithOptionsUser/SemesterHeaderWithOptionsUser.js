...
function SemesterHeaderWithOptionsUser({ semesterInfo, currentSemester, chooseSemester, isDisciplineOpen, backToSemester }) {
...
export default SemesterHeaderWithOptionsUser;