...
function ViewStudentPopup({ isOpen, onClose, currentStudent }) {
  ...
  return (
    ...
    >
      ...
      <div className='popup__author'>
        ...
        ?
        <img className='popup__author-img' src={currentStudent.avatar} alt='аватар'></img>
        :
