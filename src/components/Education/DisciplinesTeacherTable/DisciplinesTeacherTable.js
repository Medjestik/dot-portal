...
import './DisciplinesTeacherTable.css';
import Table from '../../Table/Table.js';
import TableCard from '../../Table/TableCard/TableCard.js';

function DisciplinesTeacherTable({ windowWidth, disciplines, openDiscipline }) {
            ...
            <li className='table-card__item' key={i}>
              ...
              <div className='table-card__info'>
                <ul className='table-card__info-list'>
                  ...
                  <li className='table-card__info-item'>
                    <p className='data__text'><span className='data__text_font_bold'>Контроль:</span>{item.control}</p>
                  </li>
                </ul>
              </div>
            </li>
