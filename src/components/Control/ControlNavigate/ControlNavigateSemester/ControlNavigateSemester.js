        ...
        <div className={`control-navigate__column ${windowWidth > 833 && 'control-navigate__column_margin_right'}`}>
          ...
          <ul className='control-navigate__column-list'>
            <li className='control-navigate__column-item'>
              <Link className='control-navigate__column-link' to='/control/sem/groups/bak'>Создать новый</Link>
            </li>
            <li className='control-navigate__column-item'>
              <Link className='control-navigate__column-link' to='/control/sem/list'>Список семестров</Link>
            </li>
          </ul>
        </div>
        {
